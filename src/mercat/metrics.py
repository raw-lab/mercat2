...
def PCA1(s):
    ...
    # fig.show()
    plot(fig, filename=s+'/'+'PCA_plot'+".html", auto_open=False)
    ...
    plt.savefig(s+'/'+'PCA_plot_ScreePlot'+".png")
    # plt.write_html(s+'/'+'PCA_plot_ScreePlot'+".html")
    # plot(fig1, filename=s+'/'+'PCA_plot_ScreePlot'+".html", auto_open=False)
